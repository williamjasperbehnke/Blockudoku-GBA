...
namespace blockudoku
{
            ...
            int music_volume_percent, bool assist_enabled)
    {
        ...
        renderer._accent_text_generator.generate(-108, -52, "BLOCKUDOKU", renderer._text_sprites);
        renderer._text_generator.generate(-108, -36, "GBA EDITION", renderer._text_sprites);

        renderer._accent_text_generator.generate(-108, -12, "MENU", renderer._text_sprites);
        (menu_index == 0 ? renderer._accent_text_generator : renderer._text_generator)
                .generate(-108, -2, menu_index == 0 ? "> START GAME" : "  START GAME", renderer._text_sprites);
        (menu_index == 1 ? renderer._accent_text_generator : renderer._text_generator)
                .generate(-108, 8, menu_index == 1 ? "> HIGH SCORES" : "  HIGH SCORES", renderer._text_sprites);
        (menu_index == 2 ? renderer._accent_text_generator : renderer._text_generator)
                .generate(-108, 18, menu_index == 2 ? "> CREDITS" : "  CREDITS", renderer._text_sprites);
        ...
        (menu_index == 3 ? renderer._accent_text_generator : renderer._text_generator)
                .generate(30, -43, menu_index == 3 ? "> SFX" : "  SFX", renderer._text_sprites);
        ...
        (menu_index == 4 ? renderer._accent_text_generator : renderer._text_generator)
                .generate(30, -19, menu_index == 4 ? "> MUSIC" : "  MUSIC", renderer._text_sprites);
        ...
        (menu_index == 5 ? renderer._accent_text_generator : renderer._text_generator)
                .generate(30, 5, menu_index == 5 ? "> BLOCKS" : "  BLOCKS", renderer._text_sprites);
        ...
        (menu_index == 6 ? renderer._accent_text_generator : renderer._text_generator)
                .generate(30, 29, menu_index == 6 ? "> PALETTE" : "  PALETTE", renderer._text_sprites);
        ...
        (menu_index == 7 ? renderer._accent_text_generator : renderer._text_generator)
                .generate(30, 53, menu_index == 7 ? "> ASSIST" : "  ASSIST", renderer._text_sprites);
        renderer._text_generator.generate(30, 63, assist_enabled ? "  ON" : "  OFF", renderer._text_sprites);

        const auto& entries = scores.entries();
        renderer._accent_text_generator.generate(-108, 40, "BEST", renderer._text_sprites);
        ...
        renderer._text_generator.generate(-108, 50, best_text, renderer._text_sprites);

        bn::string<32> seed_text("SEED ");
        seed_text += bn::to_string<12>(entries[0].seed);
        renderer._text_generator.generate(-108, 60, seed_text, renderer._text_sprites);
